...
<div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
  ...
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php if (isset($text_footer)) echo $text_footer; ?></p>
  <p style="margin-top: 0px; margin-bottom: 20px;"><?php if (isset($text_powered)) echo $text_powered; ?></p>
</div>
</body>
</html>
