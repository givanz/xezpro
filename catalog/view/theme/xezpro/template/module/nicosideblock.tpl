...
nico_add_js($_facebook_js);?>
			...
			?>
				...
				<a class="twitter-timeline" data-dnt="true"  data-chrome="nofooter noborders noscrollbar noheader transparent" href="https://twitter.com/twitterapi" href="https://twitter.com/twitterapi" data-widget-id="<?php echo $slide['twitter_id'];?>"></a>
				<?php 
