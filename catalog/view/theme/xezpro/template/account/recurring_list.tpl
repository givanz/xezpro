...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <?php if (isset($recurrings)) $profiles = $recurrings; if (isset($profiles) && $profiles) { ?>
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          <thead>
            <tr>
              <td class="text-left"><?php if (isset($column_profile_id)) echo $column_profile_id;else echo $column_recurring_id ?></td>
              <td class="text-left"><?php if (isset($column_created)) echo $column_created;else echo $column_date_added; ?></td>
