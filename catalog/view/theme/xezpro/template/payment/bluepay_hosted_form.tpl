<form action="https://secure.bluepay.com/interfaces/shpf" method="POST">
    ...
    <div class="buttons">
        <div class="pull-right">
            <input type="submit" value="<?php echo $button_confirm; ?>"  id="button-confirm" data-loading-text="<?php echo isset($text_loading)?$text_loading:'Loading...'; ?>" class="btn btn-primary" />
        </div>
    </div>
</form>
