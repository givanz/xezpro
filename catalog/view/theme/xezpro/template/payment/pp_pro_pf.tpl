...
if ($_config) $_config =  $this->registry->get('config');
...
$('#button-confirm').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment').before('<div class="attention"><img src="catalog/view/theme/<?php echo $theme_name;?>/img/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
